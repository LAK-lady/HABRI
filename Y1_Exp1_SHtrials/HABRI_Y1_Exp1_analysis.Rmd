...
```{r}
data<-read.csv(file="HABRI_Y1_Experiment1/Cleaned_data/Y1_Exp1_allData.csv", header=TRUE)
```
...
png(file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure2.png", width=4,height=4, units="in", res=1200)
...
```{r}
png(file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure10.png", 
...
print(summary_chla, n=30) #prints the table
...
SI_fig3<- ggplot(data=data2, 
  ...
  theme_classic() +
  theme(axis.text.x = element_text(angle =g 90, hjust=0.5,vjust=0.5),
        legend.position="none")  

SI_fig3
ggsave(SI_fig3, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure3_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
SI_fig4<- ggplot(data=data2, 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust=0.5,vjust=0.5),
        legend.position = "none") 
SI_fig4
ggsave(SI_fig4, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure4_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
SI_fig8
ggsave(SI_fig8, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure8_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
print(summary_TP, n = 30)

### post SRP measurements ###
summary<- data2 %>%
  group_by(Lake, Treatment) %>%
  summarise(avg=mean(PO4_P_ugL, na.rm=TRUE),
            sd=sd(PO4_P_ugL, na.rm = TRUE))
print(summary, n = 30)

### post NH4 measurements ###
summary<- data2 %>%
  group_by(Lake, Treatment) %>%
  summarise(avg=mean(NH4_N_ugL, na.rm=TRUE),
            sd=sd(NH4_N_ugL, na.rm = TRUE))
print(summary, n = 30)

### post NO3 measurements ###
summary<- data2 %>%
  group_by(Lake, Treatment) %>%
  summarise(avg=mean(NO3_N_ugL, na.rm=TRUE),
            sd=sd(NO3_N_ugL, na.rm = TRUE))
print(summary, n = 30)
```
...
SI_fig11a
ggsave(SI_fig11a, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure11a_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
SI_fig12a<-ggplot(data=SHtest_PC, #plots the model
  ...
  labs(x="Pre Phycocyanin (ug/L), log10-transformed",
       ...
       color="Treatment", shape="Source Water")
SI_fig12a
ggsave(SI_fig12a, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure12a_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
SI_fig13a<-ggplot(data=SHtest_MC, #plots the model
  ...
  labs(x="Pre Microcystin (ug/L), log10-transformed",
       ...
       color="Treatment")
SI_fig13a
ggsave(SI_fig13a, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure13a_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
fig2
#ggsave(fig2, file="HABRI_Y1_Experiment1/Products/Figure2.jpeg", device="jpeg", width=8, height=4, units="in", dpi=1200)
```
...
SI_fig14a<- ggplot(data=SHtest2_Chl, #plots the model
  ...
  labs(x="Pre Chlorophyll-a (ug/L), log10-transformed",
       ...
       color="Treatment")
SI_fig14a
ggsave(SI_fig14a, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure14a_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
Figure3<- ggplot(data=SHtest2_Chl, aes(x=Lake, y=Chl_diff_ugL,
  ...
  stat_compare_means(label="p.signif", size=8, label.y=300,
                     method="t.test")
Figure3
#ggsave(Figure3, file="HABRI_Y1_Experiment1/Products/Figure3_color.png", device="png", width=5, height=5, units="in", dpi=1200)
```
...
SI_fig15a<- ggplot(data=SHtest2_PC, #plots the model
  ...
  labs(x="Pre Phycocyanin (ug/L), log10-transformed",
       ...
       color="Treatment")
SI_fig15a
ggsave(SI_fig15a, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure15a_color.png",device="png", width=5, height=5, units="in", dpi=1200)
...
SI_fig16a<- ggplot(data=SHtest2_MC, #plots the model
  ...
  labs(x="Pre Microcystin (ug/L), log10-transformed",
       ...
       color="Treatment")
SI_fig16a
ggsave(SI_fig16a, file="HABRI_Y1_Experiment1/Products/SI_Figures/SI_Figure16a_color.png",device="png", width=5, height=5, units="in", dpi=1200)
